...
Requests can be made by various means. In this exercise we propose using [Postman](###configuring-postman) or via [cURL](###configuring-curl). Feel free to use your mechanism of choice.
...
2. Import the environment environment.
![](misc/img/environment.png)
![](misc/img/import_env.png)
3. Add your write to the environment variable.
